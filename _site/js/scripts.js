(function($) {
    ...
    if (typeof staticGoogleMaps !== 'undefined') {
        $('#canvas-map').addClass('image-section').css(
          'background-image',
          'url(https://maps.googleapis.com/maps/api/staticmap?zoom=17&center=' + mobileCenterMapCoordinates +
          '&key=AIzaSyCPeTzfAEKac4a3nlkQA4YCBXvVBnXosf8' +
          '&size=' + $(window).width() + 'x700&scale=2' +
          '&language=en&markers=icon:' + icon + '|' + eventPlaceCoordinates +
